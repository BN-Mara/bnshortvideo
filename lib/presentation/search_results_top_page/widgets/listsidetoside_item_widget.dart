...
class ListsidetosideItemWidget extends StatelessWidget {
  ListsidetosideItemWidget(this.listsidetosideItemModelObj);

  ListsidetosideItemModel listsidetosideItemModelObj;
